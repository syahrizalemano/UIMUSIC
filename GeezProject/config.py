...
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", " MUSIC")
BG_IMAGE = getenv("BG_IMAGE", "https://telegra.ph/file/898321f1318ab1c1e3f94.png")
admins = {}
API_ID = int(getenv("API_ID"))
API_HASH = getenv("API_HASH")
BOT_USERNAME = getenv("BOT_USERNAME")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "😈 MUSIC")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "😈 MUSIC")
PROJECT_NAME = getenv("PROJECT_NAME", "😈 MUSIC")
OWNER = getenv("OWNER", "@VckyouuBitch")
SOURCE_CODE = getenv("SOURCE_CODE", "https://github.com/syahrizalemano/UIMUSIC")
