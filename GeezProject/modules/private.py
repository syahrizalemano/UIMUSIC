...
async def start_(client: Client, message: Message):
    await message.reply_text(
        f"""<b>Haii {message.from_user.first_name} {PROJECT_NAME}\n
Adalah Bot Music Group yang dapat Memutar Lagu di Voice Chat Group Anda Dengan Mudah
...
Ingin Menambahkan Saya ke Grup Anda? Tambahkan Saya Ke Group Anda!
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("🎁 Donate", url=f"https://t.me/bcddgblg")],
            ]
        ),
...
def map(pos):
    if pos == 1:
        ...
        button = [
            ...
            [
                InlineKeyboardButton(
                    text="💬 Channel Updates", url=f"https://t.me/{UPDATES_CHANNEL}"
                ),
                InlineKeyboardButton(
...
async def help(client: Client, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("ME", url="https://t.me/bcddgblg")]]
        ),
    )
...
async def reload(client: Client, message: Message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Group Support", url=f"https://t.me/ANOBOTZ"),
                    InlineKeyboardButton("Managed By", url=f"https://t.me/bcddgblg"),
                ]
            ]
        ),
    )
